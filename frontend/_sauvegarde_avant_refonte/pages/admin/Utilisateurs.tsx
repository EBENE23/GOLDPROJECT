...
export default function Utilisateurs() {
  ...
  const disableUser = async (
    ...
    const confirmed = window.confirm(
      `Voulez-vous désactiver le compte de ${user.prenom} ${user.nom} ?`
    );
  ...
  return (
    <div className="min-h-full bg-slate-50 p-3 sm:p-5 lg:p-8">
      ...
      {selectedUser && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/50 p-3 sm:p-4">
      ...
      {zoneUser && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-950/50 p-3 sm:p-4">
          <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 p-4 sm:p-5">
              <div>
                <h2 className="text-sm font-bold text-slate-900">
